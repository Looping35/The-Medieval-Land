...
public class MCreatorStrangeWoodStair extends Elementstml.ModElement {
	@ObjectHolder("tml:strangewoodstair")
	public static final Block block = null;

	public MCreatorStrangeWoodStair(Elementstml instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(new Block(Block.Properties.create(Material.ROCK)).getDefaultState(), Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(3f, 15f).lightValue(0).harvestLevel(3).harvestTool(ToolType.AXE));
			setRegistryName("strangewoodstair");
		}
