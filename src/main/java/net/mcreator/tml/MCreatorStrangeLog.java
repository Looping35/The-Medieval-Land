...
public class MCreatorStrangeLog extends Elementstml.ModElement {
	@ObjectHolder("tml:strangelog")
	public static final Block block = null;

	public MCreatorStrangeLog(Elementstml instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.5f, 13f).lightValue(0).harvestLevel(3)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("strangelog");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Is that... wood ?..."));
		}
