...
public class MCreatorCompactLog extends Elementstml.ModElement {
	@ObjectHolder("tml:compactlog")
	public static final Block block = null;

	public MCreatorCompactLog(Elementstml instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.STONE).hardnessAndResistance(4f, 13f).lightValue(0).harvestLevel(4)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("compactlog");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("So compact that nothing can burn it."));
		}
