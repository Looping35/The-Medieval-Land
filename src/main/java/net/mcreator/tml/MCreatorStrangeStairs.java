...
public class MCreatorStrangeStairs extends Elementstml.ModElement {
	@ObjectHolder("tml:strangestairs")
	public static final Block block = null;

	public MCreatorStrangeStairs(Elementstml instance) {
		super(instance, 17);
	}
