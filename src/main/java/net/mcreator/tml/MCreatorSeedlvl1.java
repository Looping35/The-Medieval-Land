...
public class MCreatorSeedlvl1 extends Elementstml.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("seedlvl1"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("seedlvl1");
		}
